...
void setup() {
  ...
  plot.Begin();
  plot.AddTimeGraph("Distance running avg in mm", 1000, "Sensor 1", runningAvg, "Sensor 2", runningAvg_2, "Sensor 3", runningAvg_3, "Sensor 4", runningAvg_4, "Sensor 5", runningAvg_5);
